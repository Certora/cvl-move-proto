...
/*
    ...
    The idea is that every CVL module can contain a `cvl_manifest` function that describes the CVL-specific attributes.
    ...
    use cvl::manifest::{ rule, summary, ghost_mapping };
...
public native fun ghost_mapping(funName: vector<u8>);
public native fun hash_fun(funName: vector<u8>);
